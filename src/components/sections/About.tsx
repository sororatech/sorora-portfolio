...
export default function AboutPage() {
  return (
    <section 
      id="about" 
      // Removed bg-[#0a0a0a] and border-t to match Hero's transparent/inherited background
      // Updated padding to match Hero's spacing (px-6 md:px-16 pt-24)
    ...
    >
      ...
      <header className="z-10 relative mb-12 sm:mb-20">
        ...
        >
          <motion.h1
            className="text-3xl sm:text-4xl font-bold tracking-tighter text-center"
      ...
      {/* Description Section */}
      <section className="relative z-10 max-w-2xl space-y-12 mx-auto lg:mx-0">
        <motion.div 
          initial="hidden" 
          whileInView="visible" 
          viewport={{ once: true }} 
        ...
        >
          ...
          <motion.p 
            ...
            className="text-white text-base md:text-lg font-light leading-relaxed border-l-2 border-pink-500 pl-6"
          >
