...
export default function AboutPage() {
  ...
  return (
    // Changed main container to a section containing the necessary tracking id
    <section id="about" className="min-h-screen bg-[#0a0a0a] text-white p-8 md:p-16 overflow-hidden relative border-t border-zinc-900">
      {/* Structural Lines */}
      <div className="absolute top-[30%] left-0 w-full h-[1px] bg-white/5 z-0" />
      <div className="absolute top-0 left-[75%] w-[1px] h-full bg-white/5 z-0" />
      ...
      >
        <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border border-pink-500/20 flex items-center justify-center bg-[#0a0a0a] shadow-[0_0_40px_rgba(255,255,255,0.2)]">
          <motion.img
