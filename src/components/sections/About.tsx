...
export default function AboutPage() {
  return (
    <section
      id="about"
      className="text-white relative overflow-x-hidden px-4 sm:px-6 md:px-10 lg:px-16 pt-10 sm:pt-14 md:pt-20 pb-12 sm:pb-16"
    >
      {/* Header */}
      <header className="z-10 relative mb-6 sm:mb-8 lg:mb-12">
        <motion.div
          initial="hidden"
          animate="visible"
        ...
        >
          <motion.h1
            className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tighter text-center lg:text-left"
      ...
      <section className="relative z-10 w-full max-w-7xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          variants={{ visible: { transition: { staggerChildren: 0.3 } } }}
          className="max-w-2xl mx-auto lg:mx-0 space-y-5 sm:space-y-6 lg:space-y-10"
        >
          {/* Main paragraph */}
          <motion.p
            variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }}
            className="text-gray-400 text-sm sm:text-base lg:text-lg font-light leading-relaxed md:border-l-2 md:border-pink-500 md:pl-6"
          >
          ...
          <motion.p
            variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }}
            className="text-gray-400 text-xs sm:text-sm lg:text-base font-light mt-3 sm:mt-4 md:mt-6 md:pl-6"
          >
          ...
          <motion.p
            variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }}
            className="text-gray-500 text-xs sm:text-sm lg:text-base font-light mt-2 sm:mt-3 md:mt-4 md:pl-6"
          >
      ...
      >
        <div className="w-28 h-28 xl:w-32 xl:h-32 rounded-full border border-pink-500/20 flex items-center justify-center bg-[#0a0a0a]/50 backdrop-blur-sm shadow-[0_0_40px_rgba(255,255,255,0.1)]">
          <motion.img
